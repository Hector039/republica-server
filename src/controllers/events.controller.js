...
export default class EventsController {
    ...
    updateEvent = async (req, res, next) => {
        const { eid } = req.params;
        const { event_date, event_name, event_description, inscription_price } = req.body;
        try {
            ...
            const updatedEvent = await this.eventsService.updateEvent(eid, { event_date, event_name, event_description, inscription_price });
    ...
    addEvent = async (req, res, next) => {
        ...
        try {
            ...
            const event = await this.eventsService.addEvent({ event_date, event_name, event_description, inscription_price });
